...
@interface EditJournalViewController : UIViewController <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
...
@property(nonatomic, retain) NSString* editComments;
