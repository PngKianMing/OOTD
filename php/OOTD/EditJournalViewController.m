...
@implementation EditJournalViewController

@synthesize photoButton = photoButton_;
@synthesize photo = photo_,comments,editComments;
...
- (void)viewDidLoad
{
    ...
    [self.photoButton setImage:photo_ forState:UIControlStateNormal];
    self.comments.text = editComments;
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info 
{
	...
	[self.photoButton setImage:self.photo forState:UIControlStateNormal];
     [[NSUserDefaults standardUserDefaults] setObject:UIImagePNGRepresentation(self.photo) forKey:@"EditJournalImage"];  
}
...
- (IBAction)post:(id)sender{
    ...
    if(self.photo ==nil || self.photo == [UIImage imageNamed:@"bigCam.png"]){
        ...
        [[NSUserDefaults standardUserDefaults]
         setObject:comments.text forKey:@"EditJournalText"];
        NSNotification * notification = [NSNotification notificationWithName:@"EditJournal" object:nil];
