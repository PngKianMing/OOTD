...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info 
{
	...
	[self.photoButton setImage:self.photo forState:UIControlStateNormal];
     [[NSUserDefaults standardUserDefaults] setObject:UIImagePNGRepresentation(self.photo) forKey:@"NewsImage"];  
}
...
- (IBAction)post:(id)sender{
    ...
    if(self.photo ==nil || self.photo == [UIImage imageNamed:@"bigCam.png"]){
        ...
        [[NSUserDefaults standardUserDefaults]
         setObject:comments.text forKey:@"NewsText"];
        NSNotification * notification = [NSNotification notificationWithName:@"AddNewsFeed" object:nil];
